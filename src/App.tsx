...
function App() {
  ...
  const [isCompactPortal, setIsCompactPortal] = useState(false)
  ...
  useEffect(() => {
    ...
    const handleChange = (event: MediaQueryListEvent) => {
      setIsCompactPortal(event.matches)
    }

    setIsCompactPortal(mediaQuery.matches)
  ...
  return (
    <div className="app-shell">
      ...
      {viewMode === 'dashboard' ? (
        ...
        <main className={`mobile-portal${isCompactPortal ? ' is-compact' : ''}`}>
          ...
          <section className="portal-section">
            ...
            <div
              className={`portal-coverflow${
                isCompactPortal ? ' portal-coverflow--compact' : ''
              }`}
            >
              {!isCompactPortal && (
                <button
              ...
              <div
                className={`portal-coverflow__viewport${
                  isCompactPortal ? ' is-compact' : ''
                }`}
              >
                {trucks.map((truck, index) => {
                  ...
                  const cardClasses = ['portal-card', 'glass-card']
                  if (isCompactPortal) cardClasses.push('is-compact')
            ...
            >
              ...
              >
                {tanks.map((tank, index) => {
                  ...
                  const cardClasses = ['portal-card', 'glass-card', typeColorClass]
                  if (isCompactPortal) cardClasses.push('is-compact')
                  if (isActive) cardClasses.push('is-active')
